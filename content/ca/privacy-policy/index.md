...
This privacy notice is issued by the Vectura Fertin Pharma group of companies, which is made up of a number of companies or "affiliates" as set out at the end of this notice.

"We" (or "us" or "our") refers to Vectura Fertin Pharma Inc. and its affiliates.
...
- We may collect information automatically when you interact with our systems or we communicate with you (e.g. when you use a Vectura Fertin Pharma website or, where we use technologies to observe when you receive or open e-mails).
- We may also acquire information from third parties (e.g. statistical information about the population in certain geographical areas).
...
In this notice, we refer to all the methods by which you are in contact with us as "touchpoints". Touchpoints include digital (for example, websites).
...
- use a Vectura Fertin Pharma digital touchpoint (e.g. a website);
- contact us through a touchpoint, or by e-mail;
...
- communicate with us (for example, through a touchpoint);
- use Vectura Fertin Pharma touchpoints (for example, through tracking mechanisms (such as cookies and web beacons/pixels), where we use them, that you receive when you use the Vectura Fertin Pharma touchpoint or get an e-mail from us);
- use third party websites (for example, using technology similar to that described in the bullet above, that you receive when you visit a Vectura Fertin Pharma touchpoint or get an e-mail from us); or

As mentioned above, we may collect information about you automatically through the use of cookies and similar tracking technologies (such as web beacons/pixels) that you receive when you visit digital Vectura Fertin Pharma touchpoints or get an electronic message from us. The specific cookies and other mechanisms used will depend on the touchpoint in question. To learn about these mechanisms used on a Vectura Fertin Pharma touchpoint, including how you can accept or refuse cookies, please see the information made available on or through that touchpoint. These mechanisms may include Google analytics cookies (see www.google.com/policies/privacy/partners/.)

Where permitted by law, we may acquire information about you from third parties. This may include information shared between Vectura Fertin Pharma affiliates.
...
- information you give us in communications (e.g. e-mails) you have with contact centres

Information that we collect from you directly will be apparent from the context in which you provide it.

Information that we collect from an electronic device, if you choose to send the information to us. Information that we collect automatically will generally concern:
...
- To provide product information services to you, including dealing with your inquiries and requests
...
- Vectura Fertin Pharma affiliates;
- third parties who provide Vectura Fertin Pharma affiliates or you with products or services;
- Vectura Fertin Pharma affiliates' carefully selected business partners and advertisers (in areas connected with our products, or consistent with their style and image) so that they can contact you with offers that they think may interest you, in accordance with your preferences; and
...
- Information about you will be shared with Philip Morris Products S.A. (based in Neuchâtel, Switzerland), which is the place of central administration of personal data processing for Vectura Fertin Pharma affiliates. Philip Morris Products S.A. processes the information about you for all the purposes described in this notice.
- Information about you may be shared with the Vectura Fertin Pharma affiliate that is responsible for the country in which you live (if it wasn't the Vectura Fertin Pharma affiliate that first collected the information) for all the purposes described in this notice.
- Information about you may be shared with any other Vectura Fertin Pharma affiliate that you contact (for example information on Vectura Fertin Pharma products) in order to enhance our service to you.

Details of Vectura Fertin Pharma affiliates and the countries in which they are established are available via our website.

Sharing data with Third Parties

- To the extent permitted by applicable law, we may share information about you with third parties who provide Vectura Fertin Pharma affiliates or you with products or services (such as advisers and information services providers).
- To the extent permitted by applicable law, we may share information about you with Vectura Fertin Pharma affiliates' carefully selected third party business partners and advertisers (in line with the kind of thing you might associate with our products, for example because they have similar or complementary image, style, or functionality)
...
For example, we and other Vectura Fertin Pharma affiliates within the EU and EEA may transfer personal information to Vectura Fertin Pharma affiliates, or to their service providers, outside the EU and EEA. In all such cases, the transfer will be:
...
If you have any questions, or wish to exercise any of your rights, you can find contact details for the relevant Vectura Fertin Pharma affiliate, and if applicable data protection officer, linked to at the top of this notice. Contact details will also be given in any communications that a Vectura Fertin Pharma affiliate sends you.

If your country has a data protection authority, you have a right to contact it with any questions or concerns. If the relevant Vectura Fertin Pharma affiliate cannot resolve your questions or concerns, you may also have the right to seek judicial remedy before a national court.
...
| Metadata | |
| -------- | --------- |
| Title | Privacy Policy - Luo |
| Description | Luo Medical Canada Privacy Policy |
